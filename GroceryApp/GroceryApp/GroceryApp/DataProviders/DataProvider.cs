...
namespace GroceryApp.DataProviders
{
    public class DataProvider
    {
        ...
        public static List<OrderBill> ListOrders = new List<OrderBill>
            {
                ...
                new OrderBill{
                    ...
                    Note="Giao hàng từ 6->8h sáng",
                    State="RECEIVED",
                    Review="Đồ ăn không được tươi lắm",
                    StoreAnswer="Mong phục vụ bạn tốt hơn lần sau!",
                    Rating=2,
                    OrderedProducts=ListProducts
                },
                new OrderBill{
        ...
        public static List<Product> ListProductManager = new List<Product>
            {
                new Product{
                    ID=0,
                    IDType=2,
                    ...
                    QuantityOrder=4,
                    Price=2000,
                    ImageURL="https://cf.shopee.vn/file/79f21357cd08240430c1b2a298507c9c",
                    StateInStore="SOLD"
                    },
                new Product{
                    ID=1,
